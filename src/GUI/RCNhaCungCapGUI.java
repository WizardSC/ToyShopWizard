...
public class RCNhaCungCapGUI extends javax.swing.JDialog {
    ...
    /**
     * Creates new form RCNhaCungCapGUI
     */
    public RCNhaCungCapGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RCNhaCungCapGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RCNhaCungCapGUI dialog = new RCNhaCungCapGUI(new javax.swing.JFrame(), true);
