 ...
 * @author Phuc Toan
 */
public class XuatPhieuXuatBUS {
    private String file = "./reports/test.pdf";
    private ArrayList<CTPhieuXuatDTO> dsctpx = new ArrayList<CTPhieuXuatDTO>();
    private PhieuXuatDTO px;    
    private BaseFont bf;

    public XuatPhieuXuatBUS() {
    }
    
    public XuatPhieuXuatBUS(PhieuXuatDTO px,ArrayList<CTPhieuXuatDTO> dsctpx) 
    {
        this.px = px;
        file = "./reports/PhieuXuat"+px.getMaPX()+".pdf";
        this.dsctpx = dsctpx;
    }
    public void print()
    {
        ...
        try {
            ...
            bill.add(header);
            bill.add(l);
            Paragraph info = new Paragraph("Phiếu xuất : "+px.getMaPX()+"          Ngày : "+px.getNgayLap(),new Font(bf,15));
            bill.add(info);
            ...
            Paragraph sum = new Paragraph("Tổng tiền: "+ px.getTongTien()+"đ",new Font(bf,20));
